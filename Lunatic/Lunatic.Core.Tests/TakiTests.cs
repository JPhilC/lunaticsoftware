...
namespace Lunatic.Core.Tests
{
   ...
   public class TakiTests
   {
      ...
      public void TakiExample5_4_4()
      {
         ...
         MountCoordinate star1 = new MountCoordinate("0h7m54.0s", "29.038°", 1.732239, 1.463808, new DateTime(2017, 03, 28, 21, 27, 56));
         MountCoordinate star2 = new MountCoordinate("2h21m45.0s", "89.222°", 5.427625, 0.611563, new DateTime(2017, 03, 28, 21, 37, 02));
      ...
      {
         MountCoordinate mirphac = new MountCoordinate("3h25m34.77s", "49°55'12.0\"", 1.04551212078025, 0.882804566344625, _localTime);
         MountCoordinate almaak = new MountCoordinate("2h04m58.83s", "42°24'41.1\"", 0.597795712351665, 0.817146830684098, _localTime);
         MountCoordinate ruchbah = new MountCoordinate("1h26m58.39s", "60°19'33.3\"", 0.506260233480349, 1.09753088667021, _localTime);
