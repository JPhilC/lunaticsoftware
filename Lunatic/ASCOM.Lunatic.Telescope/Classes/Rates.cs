...
namespace ASCOM.Lunatic.Telescope
{
   ...
   //
   // The Guid attribute sets the CLSID for ASCOM.Lunatic.Rate
   ...
   // this polymorphism. 
   //
   // The Guid attribute sets the CLSID for ASCOM.Winforms.AxisRates
   // The ClassInterface/None addribute prevents an empty interface called
   ...
   // this polymorphism. 
   //
   // The Guid attribute sets the CLSID for ASCOM.Winforms.TrackingRates
   // The ClassInterface/None addribute prevents an empty interface called
