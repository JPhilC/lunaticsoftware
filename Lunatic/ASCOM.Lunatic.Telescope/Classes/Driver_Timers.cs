...
namespace ASCOM.Lunatic.Telescope
{
   partial class Telescope
   {
      ...
      [Obsolete("Need to write code for pulse timer tick")]
      private void _PulseTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
      {
         //System.Diagnostics.Debug.WriteLine("Processing driver Pulse Timer tick");

         if (!ProcessingPulseTimerTick) {
            lock (_Lock) {
               ...
               ProcessingPulseTimerTick = false;
