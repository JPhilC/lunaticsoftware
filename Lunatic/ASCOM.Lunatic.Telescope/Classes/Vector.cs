...
namespace ASCOM.Lunatic.Telescope
{
   public class Vector
   {
      ...
      //public static Coord EQ_sp2Cs(Coord obj)
      //{
      //   Coord result;
      //   //CartesCoord tmpObj;
      //   //SphereCoord tmpObj4;

      //   // if (HC.PolarEnable.Value) = 1 {
      ...
      //public int EQ_UpdateTaki(double x, double y, int alignmentStarsCount, ThreePointAlgorithm pointAlgorithm)
      //{
      //   int result = 0;
      //   TriangleCoord tr;

      //   //    'Adjust only if there are four alignment stars
      //   if (alignmentStarsCount < 3) {
      //      return result;
      //   }


      //   switch (pointAlgorithm) {
      //      case ThreePointAlgorithm.ClosestPoints:
      ...
      //      result = EQ_AssembleMatrix_Taki(tmpCoord.X, tmpCoord.Y, ct_PointsC(tr.I), ct_PointsC(tr.J), ct_PointsC(tr.K), my_PointsC(tr.I), my_PointsC(tr.J), my_PointsC(tr.K));
      //   }
      //   return result;
      //}
