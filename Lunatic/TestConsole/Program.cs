   ...
   class Program
   {
      ...
      static void TestTransforms()
      {
         ...
         using (Util util = new Util()) {
            ...
            DateTime testTime = new DateTime(2017, 3, 14, 9, 21, 27).AddSeconds(0.2).AddHours(-1*localTimeZoneOffset);
            ...
            double last = SiderealTime.LocalApparentSiderealTime(longitude, testTime);
            Console.WriteLine(string.Format("Local Siderial Time = {0}, Expecting 20:44:51.7", util.HoursToHMS(last, ":", ":", "", 1)));
