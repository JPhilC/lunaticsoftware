//
// ASCOM.UnityAstro.ASCOM.Winforms.TelescopeServer Local COM Server
//
...
{
   public static class TelescopeServer
   {
      ...
      private static TelescopeServerMainWindow _MainWindow = null;          // Reference to our main form
      private static ArrayList _ComObjectAssys;            // Dynamically loaded assemblies containing served COM objects
      ...
      private static string _AppId = "{09A57570-CF27-4026-B575-AF24FEC04858}";  // Our AppId
      ...
      private static void ElevateSelf(string arg)
      {
         ...
         si.FileName = Assembly.GetExecutingAssembly().Location;
         si.Verb = "runas";
      ...
      private static void RegisterObjects()
      {
         ...
         try {
            ...
            using (RegistryKey key = Registry.ClassesRoot.CreateSubKey(string.Format("APPID\\{0}",
                        Path.GetDirectoryName(assy.Location)))) {
               key.SetValue("AppID", _AppId);
            }
         }
         catch (Exception ex) {
            ...
            try {
               ...
               using (RegistryKey key = Registry.ClassesRoot.CreateSubKey(string.Format("CLSID\\{0}", clsid))) {
                  ...
                  using (RegistryKey key2 = key.CreateSubKey("LocalServer32")) {
                     key2.SetValue(null, assy.Location);
                  }
               }
               //
               // HKCR\CLSID\progid
...
//#endif
         ...
         _MainWindow = new TelescopeServerMainWindow();
         //if (StartedByCOM) {
         //   _MainWindow.WindowState = WindowState.Minimized;
         //}

         ASCOM.Lunatic.TelescopeServerApp app = new ASCOM.Lunatic.TelescopeServerApp();
